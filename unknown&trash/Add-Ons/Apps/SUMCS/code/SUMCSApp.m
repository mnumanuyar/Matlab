classdef SUMCSApp < handle
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            SUMCSApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'SUMCS')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong SUMCS
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'SUMCS').getString, ...
